...
import CreatorChatList from "#/components/messages/CreatorChatList";
import CreatorChatWindow from "#/components/messages/CreatorChatWindow";

// --- MOCK DATA ---
const initialChats = [
  {
    id: "c-1",
    shopName: "Routine Store",
    shopAvatar: "🛍️",
